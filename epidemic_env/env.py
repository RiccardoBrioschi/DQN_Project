...
class Env(gym.Env):
    ...
    def __init__(self,  dyn:ModelDynamics, 
        ...
        self.action_space = action_space # the one received as input
        self.observation_space = observation_space
            
        self.action_preprocessor        = action_preprocessor # we convert the action to a dictionary to make dyn work
        self.observation_preprocessor   = observation_preprocessor # it modifies the format of the observation given by the dyn
    ...
    def reset(self, seed:int=None)->Tuple[torch.Tensor,Dict[str,Any]]:
        ...
        # The observation returned by the dynamics is then converted to another format that matches the observation space
